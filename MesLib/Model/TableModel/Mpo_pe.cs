...
{
	/// <summary>
	/// Mpo_pe:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class Mpo_pe
	{
		public Mpo_pe()
		{}
		#region Model
		...
		private int _mpo_pe_index=0;
		private int _pe_next_index=-1;
		private int _mpo_pe_version=1;
		/// <summary>
		/// 
		/// </summary>
		public string id
		...
		/// 
		/// </summary>
		public string mpo_pe_no
		{
			set{ _mpo_pe_no=value;}
			get{return _mpo_pe_no;}
		}
		/// <summary>
		/// 
		/// </summary>
		...
		/// 
		/// </summary>
		public int mpo_pe_index
		{
			set{ _mpo_pe_index=value;}
			get{return _mpo_pe_index;}
		}
		/// <summary>
		/// 
		/// </summary>
		...
		/// 
		/// </summary>
		public int mpo_pe_version
		{
			set{ _mpo_pe_version=value;}
			get{return _mpo_pe_version;}
		}
		#endregion Model
