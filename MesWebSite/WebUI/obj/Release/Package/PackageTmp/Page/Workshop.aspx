<%@ Page Title="车间" Language="C#" MasterPageFile="~/StructPage.Master" AutoEventWireup="true" CodeBehind="Workshop.aspx.cs" Inherits="WebUI.Page.Workshop" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="/WebSiteScripts/Workshop.js"></script>
</asp:Content>
    ...
    <div id="TopEditFrm" style="display:none">
        <table>
            <tr>
                ...
                <td>
                    <input id="TxtWorkshopNo" class="easyui-textbox" type="text" style="width:200px"/>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input id="TxtWorkshopName" class="easyui-textbox" type="text" style="width:200px"/>
                </td>
            </tr>
            <tr>
                <td>
