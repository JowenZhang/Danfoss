<%@ Page Title="" Language="C#" MasterPageFile="~/StructPage.Master" AutoEventWireup="true" CodeBehind="Shift.aspx.cs" Inherits="WebUI.Page.Shift" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="/WebSiteScripts/Shift.js"></script>
</asp:Content>
    ...
    <div id="TopEditFrm" style="display:none">
        <table>
            <tr>
                ...
                <td>
                    <input id="TxtShiftNo" class="easyui-textbox" type="text" style="width:200px" /> 
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input id="TxtShiftName" class="easyui-textbox" type="text" style="width:200px" /> 
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <input id="TmsShiftStartTime" class="easyui-timespinner" style="width: 200px"  />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input id="TmsShiftStopTime" class="easyui-timespinner" style="width: 200px"  />
                </td>
            </tr>
        </table>
    </div>
