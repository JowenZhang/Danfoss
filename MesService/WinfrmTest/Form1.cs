...
namespace WinfrmTest
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            txtRes.Text = NormalProbability(x).ToString();
        }
        ...
        /// <returns>纵坐标</returns>
        public static double NormDensityFunc(double x, double miu, double sigma) //正态分布概率密度函数μ=0，σ=1
        {
        ...
        private static double NormalProbability(double x)
        {
